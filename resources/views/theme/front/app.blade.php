...
<head>
    ...
    <!-- Global styles START -->
    <link href="{{ asset('assets/front/plugins/font-awesome/css/font-awesome.css') }}" rel="stylesheet">
...
<body class="corporate">
    ...
    <script src="{{ asset('assets/front/plugins/fancybox/source/jquery.fancybox.pack.js') }}" type="text/javascript">
    </script><!-- pop up -->
